...
<section class="eenXColumn reverse max-width introProjectzanger">
    <section>
        <img src="http://haendel.local/wp-content/uploads/2024/09/handel-stokje-kopie.jpg" alt="#">
    </section>
    <section>
        ...
        <p>Bij uitzondering is het mogelijk om een kort traject van 4 repetities + generale repetitie en het concert mee
            te zingen. De voorwaarde is dat het werk door en door gekend is en je een hoog ervaringsniveau hebt. Dit
            wordt getoetst tijdens een auditie.</p>
    </section>
</section>
