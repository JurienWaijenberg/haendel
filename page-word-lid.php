...
<section class="eenXColumn max-width">
  ...
  <section>
    ...
    Als de kennismaking bevalt kun je direct komen meezingen op enkele repetities. Daarna maken we een afspraak voor een eenvoudige stemtest bij de dirigent. Bij de kennismaking word je ontvangen door onze gastvrouw en krijg je meer informatie over het lidmaatschap van ons koor.</p>
    <div class="doubleBtn">  <a href="#" class="btn_rood">Telefoonnummer</a>    <a href="#" class="btn_border reverseBorder">E-mail</a></div>
  </section>
</section>
