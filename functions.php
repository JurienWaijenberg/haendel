...
function bofesto_setup(){
    ...
    wp_enqueue_style( 'mediaSwiper', get_template_directory_uri() . '/styles/mediaSwiper.css');
    ...
    wp_enqueue_script( "mediaSwiper", get_template_directory_uri() . '/scripts/mediaSwiper.js', NULL, '3.5.1', true);
