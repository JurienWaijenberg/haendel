...
<section class="tweeXColumnXtitel max-width">
    <h2>WERKWIJZE VOOR HET AFSLUITEN 
    vAN OVEREENKOMST PERIODIEKE GIFT</h2>
    <section class="eenXColumn">
        <section>
        <img src="http://haendel.local/wp-content/uploads/2024/09/handel-stokje-kopie.jpg" alt="#">
        </section>
        <section class="anbiWerkwijze">
            <p>
